...
class Rule
{
     ...
     */
    private function hasValidVariables(): bool
    {
        return
    ...
    private function generate_variable_queries($tokens, $rule_id): array
    {
        ...
        foreach ($variable_tokens as $token) {
            ...
            $variable_queries[] = $variable_query;
        }
     ...
     * Generates
     * @param $rule_id
     * @return array , an array of rule query, in default, only one element.
     */
