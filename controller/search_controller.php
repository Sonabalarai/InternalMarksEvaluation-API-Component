...
use Error;
use lib\TextUtils;
use model\SearchParameters;
use function lib\search_rules;
use function lib\search_variables;
use function model\errorNoAction;
use function model\errorVariableMismatch;
use function model\evaluationResult;
...
class SearchController extends BaseController
{
     ...
     */
    private function list_rules(): array
    {
